...
const Blogs = () => {
  const [posts, setPosts] = useState(getAllBlogs());
    ...
    const load = async () => {
      try {
        ...
        if (Array.isArray(data)) {
          setPosts((prev) => mergeBlogs(prev, data as BlogPost[]));
        }
      } catch {
        ...
        <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          {posts.length > 0 ? (
            ...
            >
              ...
              >
                <Link to="/services" className="rounded-lg bg-blue-700 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-800">
                  Explore Services
                </Link>
                <Link to="/contact" className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-800 hover:bg-gray-100">
                  Contact Us
                </Link>
              </div>
            </div>
