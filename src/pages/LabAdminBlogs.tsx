...
const STORAGE_KEY = "labadmin_blogs";
...
export default function LabAdminBlogs() {
      ...
      <header className="border-b border-gray-800 bg-gray-900">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="grid w-full grid-cols-1 gap-2 sm:w-auto sm:grid-cols-2">
            <Link to="/labadmin/dashboard" className="rounded-lg bg-gray-800 px-3 py-2 text-center text-sm text-gray-200 hover:bg-gray-700">
              Back to Dashboard
            </Link>
            <Link to="/labadmin/resources" className="rounded-lg bg-gray-800 px-3 py-2 text-center text-sm text-gray-200 hover:bg-gray-700">
              Resources
            </Link>
          </div>
        </div>
      ...
      <main className="mx-auto grid max-w-7xl gap-6 px-4 py-6 sm:py-8 lg:grid-cols-[440px_1fr]">
        <section className="rounded-2xl border border-gray-800 bg-gray-900 p-5 shadow-lg">
          ...
          <form onSubmit={onSubmit} className="mt-4 space-y-3">
            ...
            <textarea value={body} onChange={(e) => setBody(e.target.value)} placeholder="Body content" rows={8} className="w-full rounded-xl border border-gray-700 bg-gray-800/90 px-3 py-2 text-white placeholder:text-gray-400 focus:border-yellow-400 focus:outline-none" required />
