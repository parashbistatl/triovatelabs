...
const ResourceDetail = ({ slug, initialResource }: ResourceDetailProps) => {
  const fallbackResource = useMemo(() => getResourceBySlug(slug || ""), [slug]);
  const [resource] = useState<ResourceItem | undefined>(initialResource ?? fallbackResource);
      ...
      <div className="flex min-h-screen flex-col bg-white">
        <main className="py-12">
          <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <Link href="/resources" className="mt-6 inline-flex text-blue-700 hover:text-blue-800">
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      <main className="py-12">
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <Link href="/resources" className="inline-flex items-center rounded-lg bg-blue-700 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-800">
            Back to Resources
          </Link>
          ...
          <img
            ...
            alt={resource.title}
            className="mx-auto mt-8 max-h-[420px] w-full rounded-2xl border border-gray-200 object-contain"
          />
          ...
          <div className="mt-6">
            <Link href="/resources" className="inline-flex items-center rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-800 hover:bg-blue-100">
              Back to All Resources
            </Link>
          </div>
        </section>
