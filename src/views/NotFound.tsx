            ...
            <Reveal delayMs={180}>
              <div className="pt-12 border-t border-gray-200 max-w-xl mx-auto">
                ...
                <div className="flex flex-wrap items-center justify-center gap-6">
                  <Link href="/about" className="text-gray-700 hover:text-gold transition-colors flex items-center gap-2 group">
                    <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                    <span>About Us</span>
                  </Link>
                  <Link href="/services" className="text-gray-700 hover:text-gold transition-colors flex items-center gap-2 group">
                    <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                    <span>Services</span>
                  </Link>
                  <Link href="/contact" className="text-gray-700 hover:text-gold transition-colors flex items-center gap-2 group">
                    <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
                    <span>Contact</span>
                  </Link>
                </div>
